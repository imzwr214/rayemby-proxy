// Dashboard HTML shell. Real source file (issue #20): the former
// dashboard/html/chunk*.js template-literal chunks + join('\n') barrel are
// gone — this single template literal stays a server-side template (it
// interpolates the hashed asset paths + current version per render), so it
// is not promoted to a static asset like app.css / app.js.
...
<body class="shell-on">
    ...
    <div class="app-shell">
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="stats-charts">
                    <section class="stats-panel stats-panel-trend" aria-labelledby="trendTitle">
                        <h3 class="stats-panel-title" id="trendTitle"><svg class="sp-ico" aria-hidden="true"><use href="#i-zap"/></svg>近 7 天播放趋势<span class="stats-panel-meta">有效播放 · 次</span></h3>
                ...
                <section class="stats-panel" aria-labelledby="top5Title">
                    <h3 class="stats-panel-title" id="top5Title"><svg class="sp-ico" aria-hidden="true"><use href="#i-star"/></svg>今日节点流量消耗 · TOP 5</h3>
            ...
            <!-- Operations Cockpit · 运维看板：verdict-first + Four Golden Signals -->
                ...
                <div class="section-header-row">
                    ...
                    <div style="display: flex; gap: 8px; align-items:center; flex-wrap: wrap;">
                        ...
                        <div class="view-toggle" role="group" aria-label="前缀打码">
                            <button type="button" id="mask-prefix-btn" class="view-toggle-btn is-active" onclick="togglePrefixMask()" title="前缀已打码 · 点击显示明文" aria-label="切换前缀打码" aria-pressed="true">
                ...
                <details class="ov-monitor" id="ovMonitor">
                    ...
                    <div class="ov-monitor-body">
                        <div class="ov-monitor-actions">
                            <span class="ov-monitor-fact"><span class="ov-monitor-fact-dot"></span>每分钟探测 · 连续 5 分钟失败告警 · 全部节点自动拉取媒体计数</span>
                        </div>
...
// 弱 ETag：随版本号与内容长度变化。任一 UI 改动几乎都会改变长度，版本号兜底。
// 用于 / 面板响应的条件请求（304），避免每次加载重复下载约 450KB HTML。
